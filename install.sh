...
# pacman
sudo pacman -Syu
sudo pacman -S amd_ucode ansible ansible-lint firefox gdm git gnome-control-center gnome-logs gnome-disk-utility keepassxc less shellcheck shfmt ufw wget
