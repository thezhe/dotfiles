...
# pacman
sudo pacman -Syu
sudo pacman -S amd_ucode firefox gdm git gnome-control-center gnome-logs gnome-disk-utility jdk-openjdk keepassxc less podman podman-docker shellcheck shfmt ufw
